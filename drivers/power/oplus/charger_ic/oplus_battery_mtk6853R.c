...
//====================================================================//
#ifdef OPLUS_FEATURE_CHG_BASIC
/* changsheng.long@BSP.CHG.Basic, 2020/12/17, lcs Add for cc detect */
	...
	enum power_supply_property psp, union power_supply_propval *val)
{
	...
	if (pinfo->data.dual_charger_support) {
		...
		case POWER_SUPPLY_PROP_CHARGE_FULL_DESIGN:
			if (g_oplus_chip) {
				val->intval = g_oplus_chip->batt_capacity_mah;
			}
			break;
...
#ifdef VENDOR_EDIT
/* longchangsheng@BSP.CHG.Basic, 2020/12/18, lcs Add for ccdetect work */
	if (oplus_ccdetect_support_check() == true){
