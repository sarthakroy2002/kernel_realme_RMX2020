...
#ifdef OPLUS_FEATURE_SENSOR
//Chendai.liang@BSP.sensor,2020/06/04,add to set pedo factory debounce
static int result = 0;
...
#endif
#ifdef OPLUS_FEATURE_SENSOR
/*Fei.Mo@PSW.BSP.Sensor, 2017/12/17, Add for clear acc cali parameter*/
	int32_t tx_buff[6] = {0};
	int ret;
...
#endif
#ifdef OPLUS_FEATURE_SENSOR
/*Fei.Mo@PSW.BSP.Sensor, 2017/12/17, Add for update acc cali parameter*/
	struct accelhub_ipi_data *obj = obj_ipi_data;
	int32_t tx_buff[6] = {0};
	int ret;
	//dynamic
